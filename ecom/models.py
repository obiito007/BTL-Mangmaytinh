...
class Product(models.Model):
    ...
    xuatban = models.CharField("xuatban",max_length=200,default='')
    tacgia = models.CharField("tacgia",max_length=200,default='')
    image = models.ImageField(upload_to='uploads/%Y/%m/%d/')
    files = models.FileField(upload_to='uploadsfile/%Y/%m/%d/',default='')
